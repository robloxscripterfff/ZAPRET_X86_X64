...
5. Для того чтобы через zapret проходили только нужные вам сайты используйте bat-файл с припиской autohostlist ## https://github.com/VayuL/Zapret_X64_X86/archive/refs/heads/main.zip - Ссылка на файл
## Решение проблем
